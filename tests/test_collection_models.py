...
class ClassifyRecruitmentTypeTests(unittest.TestCase):
    ...
    def test_internship_markers(self):
        self.assertEqual(classify_recruitment_type(title="机器人实习生"), "internship")
        self.assertEqual(classify_recruitment_type(title="AI Product Intern"), "internship")
...
class JobCandidateAsJobRecordTests(unittest.TestCase):
    ...
    def test_internship_recruitment_type_is_preserved(self):
        candidate = JobCandidate("boss", "1", "机器人实习生", "公司", recruitment_type="internship")
        record = candidate.as_job_record()
