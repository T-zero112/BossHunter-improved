...
class JobFilterTests(unittest.TestCase):
    ...
    def test_daily_salary_is_not_monthly_salary(self):
        self.assertIsNone(parse_monthly_salary_k("150-200元/天"))

    def test_parse_common_daily_salary_formats(self):
        self.assertEqual(parse_daily_salary_yuan("150-200元/天"), (150.0, 200.0))
        self.assertEqual(parse_daily_salary_yuan("200元/日"), (200.0, 200.0))
        self.assertEqual(parse_daily_salary_yuan("180至220元/天"), (180.0, 220.0))

    def test_unconvertible_salary_formats_are_not_parsed(self):
        self.assertIsNone(parse_monthly_salary_k("薪资面议"))
        self.assertIsNone(parse_daily_salary_yuan("薪资面议"))
