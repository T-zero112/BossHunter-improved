...
const windowsLocalFontSources: Record<string, Partial<Record<FontFileWeight, string>>> = {
	"Noto Sans SC": {
		100: "C:/Windows/Fonts/NotoSansSC-VF.ttf",
		200: "C:/Windows/Fonts/NotoSansSC-VF.ttf",
		300: "C:/Windows/Fonts/NotoSansSC-VF.ttf",
		400: "C:/Windows/Fonts/NotoSansSC-VF.ttf",
		500: "C:/Windows/Fonts/NotoSansSC-VF.ttf",
		600: "C:/Windows/Fonts/NotoSansSC-VF.ttf",
		700: "C:/Windows/Fonts/NotoSansSC-VF.ttf",
		800: "C:/Windows/Fonts/NotoSansSC-VF.ttf",
		900: "C:/Windows/Fonts/NotoSansSC-VF.ttf",
	},
	"Noto Sans": {
		400: "C:/Windows/Fonts/NotoSans-Regular.ttf",
		700: "C:/Windows/Fonts/NotoSans-Bold.ttf",
		"400italic": "C:/Windows/Fonts/NotoSans-Italic.ttf",
		"700italic": "C:/Windows/Fonts/NotoSans-BoldItalic.ttf",
	},
	"Noto Serif": {
		400: "C:/Windows/Fonts/NotoSerif-Regular.ttf",
		700: "C:/Windows/Fonts/NotoSerif-Bold.ttf",
		"400italic": "C:/Windows/Fonts/NotoSerif-Italic.ttf",
		"700italic": "C:/Windows/Fonts/NotoSerif-BoldItalic.ttf",
	},
};
...
export function getWebFontSource(family: string, weight: FontWeight = "400", italic = false) {
	if (isWindowsRuntime()) {
		const localFiles = windowsLocalFontSources[family];
		if (localFiles) {
			const key = `${weight}${italic ? "italic" : ""}` as FontFileWeight;
			return localFiles[key] ?? localFiles[weight] ?? localFiles["400"];
		}
	}
