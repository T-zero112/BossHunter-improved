...
export function useJobSearch(
  ...
  useEffect(() => {
    ...
    if (filters.dailySalaryMin) params.set('daily_salary_min', filters.dailySalaryMin)
    if (filters.dailySalaryMax) params.set('daily_salary_max', filters.dailySalaryMax)
  ...
  }, [debouncedQuery, filters.minScore, filters.salaryMin, filters.salaryMax, filters.dailySalaryMin, filters.dailySalaryMax, filters.status, filters.createdWithin, filters.sourcePlatform, filters.education, filters.recruitmentType, page, pageSize, sortBy, sortOrder, revision])
